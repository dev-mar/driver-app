...
android {
    namespace = "com.taxitexi.texi_driver_app"
    ...
    productFlavors {
        create("dev") {
            ...
            resValue("string", "app_name", "Texi Conductor DEV")
        }
        create("prod") {
            dimension = "environment"
            resValue("string", "app_name", "Texi Conductor")
        }
    }

    defaultConfig {
        applicationId = "com.taxitexi.texi_driver_app"
